array<UILayerWrapper@> Race = {
    ...
    RespawnHelperUILayer("Race_RespawnHelper", "Respawn Helper", "appears after some time when car standing still"),
    CheckpointUILayer("Race_Checkpoint", "Checkpoint", "checkpoint info",
        {
    ...
    TimeGapUILayer("Race_TimeGap", "Time Gap", "time gap bottom right showing diff between players"),
    ...
    CountdownUILayer("Race_Countdown", "Countdown", "countdown on an online server"),
    ...
    RecordsUILayer("Race_Record", "Records", "records table on left"),
    UILayerWrapper("Race_BigMessage", "Big Message", "unknown location (missing context)"),
    BlockHelperUILayer("Race_BlockHelper", "Block Helper", "block effect messages"),
    ...
    BestRaceViewerUILayer("Race_BestRaceViewer", "Best Race Viewer", "best times on right"),
